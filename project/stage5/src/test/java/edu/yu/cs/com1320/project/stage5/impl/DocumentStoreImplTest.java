...
A Document is considered to be â€œusedâ€� whenever it is accessed as a result of a call to any part of DocumentStoreâ€™s public API. In other words, if it is â€œputâ€�,
or returned in any form as the result of any â€œgetâ€� or â€œsearchâ€� request, or an action on it is undone via any call to either of the DocumentStore.undo methods.
     */
    ...
    public void stage4TestMaxDocBytesViaSearch() {
        ...
        System.out.println(" ");
        System.out.println(" ");
        System.out.println("find pdf2");
        System.out.println("pdfTxt2 " +uri2);
