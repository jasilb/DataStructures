...
public class BTreeImpl<Key extends Comparable<Key>, Value> implements BTree<Key, Value> {
		private PersistenceManager<Key, Value> manager;// serialize-turn doc into json... deserialize - turn json into doc (can also be null, can use that to see if there is a document)
	...
	public Value get(Key k) {
	     ...
	     */
	        ...
	        if(entry == null)
	        {//if val ==null ->return other and deseralize
	            return null;
	        }
	        else {
	...
	public Value put(Key k, Value v) {
	        ...
	        if(alreadyThere != null)
	        {
	        	if(alreadyThere.val != null) {
	        		Value val = (Value) alreadyThere.val;
		            alreadyThere.val = v;
		            return val;
	        	}
	        	if(alreadyThere.val == null) {
	        		Value SDoc = null;
					try {
						System.out.println("make SDoc");
						SDoc = manager.deserialize(k);
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
	        ...
	        // null if no new node was created (i.e. just added a new Entry into an existing node). 
	    ...
	    private Node put(Node currentNode, Key key, Value val, int height)
	    {
	        ...
	        if (currentNode.entryCount < BTreeImpl.MAX)
	        {
	            ...
	            //so just return null
	        	System.out.println("Btree location: " +j);
	            return null;
	        }
	        else
	        {
	    ...
	    {
	    	System.out.println("k2 "+k2+ ", " + k2.hashCode());
	    	System.out.println("k1 "+k1+ ", " + k1.hashCode());
